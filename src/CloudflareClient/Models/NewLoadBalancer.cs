...
namespace CloudflareClient.Models
{
  ...
  /// <param name="HostName">The DNS hostname to associate with your Load Balancer. If this hostname already exists as a DNS record in Cloudflare's DNS, the Load Balancer will take precedence and the DNS record will not be used. Example: www.example.com</param>
  ...
  public record NewLoadBalancer (
    ...
    Dictionary<string, string[]> PopPools = default,
    [property: JsonPropertyName("session_affinity")]
    SessionAffinityType SessionAffinity = SessionAffinityType.None,
    [property: JsonPropertyName("session_affinity_ttl")]
    long? SessionAffinityTtl = null,
    [property: JsonPropertyName("session_affinity_attributes")]
    SessionAffinityAttributes SessionAffinityAttributes = default,
    [property: JsonPropertyName("region_pools")]
    RegionPools RegionPools = default,
    IEnumerable<Rule> Rules = default,
    long? Ttl = null);
}
