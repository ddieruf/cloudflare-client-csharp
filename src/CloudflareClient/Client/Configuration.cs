...
namespace CloudflareClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public string xAuthEmail { get; set; }
        ...
        public Configuration(
          string xAuthEmail, string xAuthKey,
        ...
        {
            string report = "C# SDK (CloudFlare) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: b5a6049d-e3b0-46ee-b7c4-d488697885a2\n";
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            var config = new Configuration((second.xAuthEmail ?? first.xAuthEmail), (second.xAuthKey ?? first.xAuthKey))
            {
                ApiKey = apiKey,
